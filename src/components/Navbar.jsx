                ...
                <div key={idx}>
                  {item.dropdownItems ? (
                    <div className="group relative">
                      ...
                      <div className="absolute left-[90%] z-10 top-2 hidden group-hover:block w-44 bg-white border rounded-sm shadow-md ml-4">
    ...
    return (
      <Link
        ...
        className={`text-base font-medium flex items-center ${isButton
          ? "text-koyya2 hover:text-white hover:bg-koyya2 border border-koyya2 rounded-md px-3 py-1"
                  ...
                  <li key={idx}>
                    <Link
                      ...
                      className={`block font-medium text-gray-700 ${link.isButton
                        ? "text-koyya2 border border-[#005592f8] px-3 py-1 rounded hover:bg-[#005592f8] hover:text-white"
                        : "hover:text-black"
                        }`}
                      onClick={() => setMenuOpen(false)}
                    >
