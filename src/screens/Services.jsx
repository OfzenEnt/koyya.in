  ...
  return (
    <div className="bg-blue-50">
      ...
      <div className="bg-blue-50 py-16 text-center">
        <h1 className="text-4xl font-bold text-[#005592f8] mb-3">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-24">
          <div className="flex  flex-col  ">
            <div className="flex flex-row items-center ">
              <h2 className="text-3xl font-bold mb-2 text-[#005592f8]">Corporate Training</h2>
            </div>
          ...
          <ul className="space-y-2 mt-4 md:mt-0">
            <h2 className="text-xl font-semibold mb-4text-[#005592f8] ">Key Features</h2>
      ...
      <div className="bg-white p-6 mt-5">
        <h2 className="text-3xl font-bold text-center text-[#005592f8] mb-3">
