        ...
        <div className="bg-blue-50" >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl  mx-auto">
                    {[
                        ...
                        <div key={i} className="p-4 flex items-center space-x-2">
                            <img src={icon} alt={title} className="w-16 h-auto" />
            ...
            <section className="bg-gray-50 py-10">
                ...
                <div className="bg-white p-10 shadow-lg rounded-md max-w-5xl mx-auto space-y-6 text-gray-700 ">
                    ...
                    <p className="flex  gap-x-3"><CircleArrowRight color="blue" size={24} className="shrink-0 mt-2 lg:mt-0" />  The program requires full-time commitment for up to 3 months.</p>
                </div>
            </section>
