    ...
    <div >
      ...
      <div className='flex p-10 max-w-7xl mx-auto justify-center items-center gap-5'>
        <div className="space-y-5">
          ...
          <p className='text-gray-500 text-xl'>Have questions or feedback? Reach out to us we'll get back to you shortly.</p>
          <div className="space-y-5 ">
            <h1 className='font-semibold text-2xl'>Follow us at:</h1>
            <ul className='flex gap-5 '>
              <li className=' p-3 w-12 h-12 flex justify-center items-center rounded-full shadow-2xl bg-gray-200 text-black hover:text-pink-500 hover:bg-pink-100 hover:text-xl transition-all duration-200 cursor-pointer'><Link to="https://www.instagram.com/koyya.enterprises" target="_blank"><FaInstagram /></Link></li>
              <li className='p-3 w-12 h-12 flex justify-center items-center rounded-full shadow-2xl bg-gray-200 text-black hover:text-blue-500 hover:bg-blue-100 hover:text-xl transition-all duration-200 cursor-pointer'><Link to="https://www.linkedin.com/company/koyya-enterprises-private-limited/" target="_blank"><FaLinkedinIn /></Link></li>
            </ul>
            <div className="space-y-2">
              <p className='flex items-center gap-4 font-bold'><FaEnvelope className=" text-koyya2 text-lg shrink-0" />Email:<a href="mailto:krishnamohan@koyya.in" className="font-normal ml-3 hover:underline">krishnamohan@koyya.in</a></p>
